...
namespace EFCore.Curso.Data
{
    public class HeroiContexto : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=HeroApp;Data Source=DESKTOP-T2DBV9N");
        }
